...
echo ""
echo "Next steps:"
echo "  1. Test locally:  docker run -p 3000:3000 -p 8000:8000 -p 8002:8002 -p 8003:8003 -e OPENAI_API_KEY=your-key ${IMAGE_NAME}:${TAG}"
echo "  2. Push to registry: docker push ${IMAGE_NAME}:${TAG}"
echo "  3. Deploy to RunPod CPU Pod (set OPENAI_API_KEY in environment)"
